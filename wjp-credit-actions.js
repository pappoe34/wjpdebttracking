/* wjp-credit-actions.js v11 — dark-mode text contrast: prefer var(--ink) over var(--text-1) so dark theme uses off-white text
 *
...
(function () {
  ...
  function buildOffersHTML(p) {
    ...
    if (!live) {
      return ''
        ...
        +     '<div><div style="font-size:10px;letter-spacing:0.10em;font-weight:800;color:var(--ink-dim, var(--text-3,#94a3b8));text-transform:uppercase;">Pre-qualified Offers</div><div style="font-size:15px;font-weight:800;color:var(--text-1,#0a0a0a);margin-top:2px;">Credit cards + loans you\'re likely approved for</div></div>'
  ...
  function buildBuildCreditHTML(p) {
    ...
    return ''
      + '<div style="margin-bottom:24px;">'
      +   '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">'
      +     '<div><div style="font-size:10px;letter-spacing:0.10em;font-weight:800;color:var(--ink-dim, var(--text-3,#94a3b8));text-transform:uppercase;">Credit Builder Tools</div><div style="font-size:15px;font-weight:800;color:var(--text-1,#0a0a0a);margin-top:2px;">Move the needle on the factors holding you back</div></div>'
  ...
  function buildScoreDetailHTML(p) {
    ...
    return ''
      ...
      +     '<div><div style="font-size:10px;letter-spacing:0.10em;font-weight:800;color:var(--ink-dim, var(--text-3,#94a3b8));text-transform:uppercase;">Score Detail</div><div style="font-size:15px;font-weight:800;color:var(--text-1,#0a0a0a);margin-top:2px;">FICO 8 · range 300 to 850</div></div>'
      +   '</div>'
      // Big score band card
      ...
      +         '<div style="font-size:42px;font-weight:900;color:var(--text-1,#0a0a0a);letter-spacing:-0.02em;line-height:1.05;">' + (score || '—') + '<span style="font-size:18px;color:var(--ink-dim, var(--text-3,#94a3b8));font-weight:700;"> / 850</span></div></div>'
  ...
  function buildFactorBreakdownHTML(p) {
    ...
    var cardsHTML = factors.map(function (f) {
      ...
      return ''
        ...
        +     '<div><div style="font-size:11.5px;font-weight:800;color:var(--text-1,#0a0a0a);">' + f.name + '</div><div style="font-size:9.5px;letter-spacing:0.08em;color:var(--ink-dim, var(--text-3,#94a3b8));font-weight:700;text-transform:uppercase;margin-top:2px;">' + f.weight + '% of score</div></div>'
    ...
    return ''
      + '<div style="margin-bottom:24px;">'
      +   '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">'
      +     '<div><div style="font-size:10px;letter-spacing:0.10em;font-weight:800;color:var(--ink-dim, var(--text-3,#94a3b8));text-transform:uppercase;">Factor Breakdown</div><div style="font-size:15px;font-weight:800;color:var(--text-1,#0a0a0a);margin-top:2px;">What\'s shaping your score, graded from your real data</div></div>'
      +   '</div>'
  ...
  function renderPage(page) {
    ...
    if (p.bureauScores) {
      ...
      Object.keys(p.bureauScores).forEach(function (k) {
        ...
        if (val) b.push('<span style="display:inline-flex;align-items:center;gap:6px;font-size:11.5px;color:var(--ink-dim, var(--text-3,#94a3b8));font-weight:700;"><span style="width:8px;height:8px;border-radius:50%;background:#a855f7;"></span>' + k.charAt(0).toUpperCase() + k.slice(1) + ' <strong style="color:var(--text-1,#0a0a0a);">' + val + '</strong></span>');
      });
    ...
    var actionCardsHTML = ''
      ...
      +   '<div><div style="font-size:10px;letter-spacing:0.10em;font-weight:800;color:var(--ink-dim, var(--text-3,#94a3b8));text-transform:uppercase;">Action Plan</div><div style="font-size:15px;font-weight:800;color:var(--text-1,#0a0a0a);margin-top:2px;">Your highest-impact moves</div></div>'
    ...
    var projectionHTML = projected > 0 ? ''
      ...
      +     '<div style="flex:1;"><div style="font-size:10px;letter-spacing:0.10em;text-transform:uppercase;font-weight:800;color:#10b981;">If you finish everything open</div><div style="font-size:18px;font-weight:900;color:var(--text-1,#0a0a0a);margin-top:2px;">Your score could move from ' + (p.currentScore || '—') + ' to ~' + ((p.currentScore || 0) + projected) + ' (+' + projected + ' pts)</div><div style="font-size:11px;color:var(--ink-dim, var(--text-3,#94a3b8));font-weight:600;margin-top:4px;">Rough estimate · actual gain depends on reporting cycles, bureau timing, and which factors move first.</div></div>'
      +   '</div>'
      + '</div>' : '';
