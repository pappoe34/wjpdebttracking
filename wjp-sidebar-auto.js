/* wjp-sidebar-auto.js v4 — Sidebar Auto mode (hover-to-expand) + cleaner
...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      ...
      'body.sidebar-auto .sidebar { width:64px; min-width:64px; transition: width .2s cubic-bezier(.2,0,0,1), min-width .2s cubic-bezier(.2,0,0,1), box-shadow .2s ease; overflow:hidden; position:relative; z-index:50; will-change: width; }',
      ...
      '@media (prefers-reduced-motion: reduce) { body.sidebar-auto .sidebar { transition-duration: .2s !important; } body.sidebar-auto .sidebar .logo-text, body.sidebar-auto .sidebar .nav-item span, body.sidebar-auto .sidebar .user-info, body.sidebar-auto .sidebar .nav-badge { transition-duration: .18s !important; } }',
  ...
  var ENTER_DELAY_MS = 60;
  var LEAVE_DELAY_MS = 120;
