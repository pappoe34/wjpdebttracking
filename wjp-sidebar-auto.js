/* wjp-sidebar-auto.js v5 — Sidebar Auto mode (hover-to-expand) + cleaner
...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      ...
      'body.sidebar-auto .sidebar { width:64px; min-width:64px; transition: width .15s cubic-bezier(.4,0,.2,1), min-width .15s cubic-bezier(.4,0,.2,1), box-shadow .15s ease; overflow:hidden; position:relative; z-index:50; will-change: width; transform: translateZ(0); contain: layout style paint; }',
      ...
      '@media (prefers-reduced-motion: reduce) { body.sidebar-auto .sidebar { transition-duration: .15s !important; } body.sidebar-auto .sidebar .logo-text, body.sidebar-auto .sidebar .nav-item span, body.sidebar-auto .sidebar .user-info, body.sidebar-auto .sidebar .nav-badge { transition-duration: .18s !important; } }',
  ...
  function wireHover(sb) {
    ...
    sb.addEventListener('mouseenter', function () {
      ...
      // v5: zero enter delay — phone-side-panel feel, instant feedback on hover
      if (ENTER_DELAY_MS === 0) {
